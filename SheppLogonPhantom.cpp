...
const long MaxImageDim = 20000;
//----------------------------------------------------------------------//
bool CSLP::Render(long nWidth, long nHeight, float** ppImage, float nBackgroundColour, CSLPEllipse* pEllipse, long nNumEllipse)
{
...
//----------------------------------------------------------------------//
void CSLP::ClearBackground(float* pImage, long nWidth, long nHeight, float clr)
{
...
//----------------------------------------------------------------------//
void CSLP::FillEllipse(float* pImage, long nWidth, long nHeight, const CSLPEllipse& ellipse)
{
